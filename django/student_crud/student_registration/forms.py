...
class RegistrationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'age': forms.NumberInput(attrs= {'class': 'form-control', 'placeholder': "Enter your full age"}),
            ...
            'sem': forms.NumberInput(attrs= {'class': 'form-control', 'placeholder': "Enter your full semester"}),
            'course': forms.TextInput(attrs= {'class': 'form-control', 'placeholder': "Enter your full course"}),
